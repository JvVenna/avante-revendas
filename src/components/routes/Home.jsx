    ...
    <body>
      ...
      <div className="box3">
        ...
        <section className='contentInfoBox'>
          <div className="infoBox3 infoBoxConfianca_hover"
            onMouseOver={changeImageConf}
            onMouseLeave={changeImageConfReturn}>
            <img
              src={afirmativo} className='confiancaHome' alt="imagem confianca" />
            <div className='contentTextInfo'>
              <h2>Confiança</h2>
              <p>Nós te pagamos á vista ou em parcelas de até 6 meses corridos após o confirmação da compra</p>
            </div>
          </div>
